<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">Billing Program</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">Invoices Paid</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">Invoices not Paid</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">Invoices Paid partially</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='profile') }}">Sections</a></li>
